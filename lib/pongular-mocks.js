/*global require: false, exports: false, global: false */
...
if(global.jasmine || global.mocha) {
  ...
  (global.afterEach || global.teardown)(function() {
    ...
    utils.forEach(pongular.callbacks, function(val, key) {
      delete pongular.callbacks[key];
    });
    if (!pongular.callbacks) {
        pongular.callbacks = {};
    }
    pongular.callbacks.counter = 0;
  });
